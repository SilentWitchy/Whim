...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> AUGUST = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(Whim.MOD_ID, "witchy"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.WITCHY_SMITHING_TEMPLATE, AUGUST);
    }

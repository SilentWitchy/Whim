...
public class ModBlocks {
    ...
    //If I want a block to not drop anything change the ".requiresCorrectToolForDrops" to .noLootTable.
    ...
    //shift twice, search block, and find every vanilla block.
...
//Must define what type of pressure plate and button. IE: Iron or stone.
    ...
    //Must define how long the button stays pressed.
    //NoCollission makes sure the button can be walked through like normal
...
//NoOcclusion makes sure these can be walked through like normal
